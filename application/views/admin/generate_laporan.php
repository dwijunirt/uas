			...
			<tbody>
				...
				<?php foreach($laporan as $l) : ?>
					<tr>
						...
						<td><?=  $l['status'] == 0 ? '<span class="badge badge-secondary">Sedang di verifikasi</span>' : $l['status'] == 'selesai' ? '<span class="badge badge-secondary">Sedang di verifikasi</span>':$l['status'] == 'tolak' ? '<span class="badge badge-secondary">Sedang di verifikasi</span>':'-'; ?>
