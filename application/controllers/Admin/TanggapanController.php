...
class TanggapanController extends CI_Controller {
	...
	public function index()
	{
		...
		$this->template->load('template','admin/tanggapan',$data);
	}
	...
	public function tanggapan_detail()
	{
		...
		if ( ! empty($cek_data)) :
			...
			// $this->load->view('_part/backend_footer_v');
			// $this->load->view('_part/backend_foot');
			$this->template->load('template','admin/tanggapan_detail',$data);
	...
	public function tanggapan_proses()
	{
		...
		// $this->load->view('_part/backend_footer_v');
		// $this->load->view('_part/backend_foot');
		$this->template->load('template','admin/tanggapan_proses',$data);
	...
	public function tanggapan_selesai()
	{
		...
		// $this->load->view('_part/backend_footer_v');
		// $this->load->view('_part/backend_foot');
		$this->template->load('template','admin/tanggapan_selesai',$data);
	}
	...
	public function tanggapan_tolak()
	{
		...
		// $this->load->view('_part/backend_footer_v');
		// $this->load->view('_part/backend_foot');
		$this->template->load('template','admin/tanggapan_tolak',$data);
	}
