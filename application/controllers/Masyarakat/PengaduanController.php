...
class PengaduanController extends CI_Controller {
	...
	public function index()
	{
		...
		if ($this->form_validation->run() == FALSE) :
			...
			$this->template->load('template','masyarakat/pengaduan',$data);
		else :
	...
	public function pengaduan_detail($id)
	{
		...
		if ( ! empty($cek_data)) :
			...
			if ($data['data_pengaduan']) :
				...
				// $this->load->view('_part/backend_footer_v');
				// $this->load->view('_part/backend_foot');
				$this->template->load('template','masyarakat/pengaduan_detail');
			else :
				$this->session->set_flashdata('msg','<div class="alert alert-danger" role="alert">
		...
		if ( ! empty($cek_data)) :
			...
			if ($cek_data['status'] == '0') :
				...
				if ($this->form_validation->run() == FALSE) :
					...
					// $this->load->view('_part/backend_footer_v');
					// $this->load->view('_part/backend_foot');
					$this->template->load('template','masyarakat/edit_pengaduan');
				else :
